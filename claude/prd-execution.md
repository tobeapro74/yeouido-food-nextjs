...
- [x] Pull-to-Refresh (홈 화면 당겨서 새로고침, 2025.01.16)
...
- [x] 앱 아이콘 생성 (1024x1024, alpha 제거)
- [x] iPhone 스크린샷 생성
- [x] iPad 스크린샷 생성 (리사이즈)
- [x] Apple Developer Program 가입
- [x] App Store Connect 앱 등록
- [x] 앱 정보 입력 (설명, 키워드, 카테고리)
- [x] 가격 설정 (무료)
- [x] 연령 등급 설정 (4+)
- [x] 개인정보 처리방침 URL 등록
- [x] 콘텐츠 권한 설정 (타사 콘텐츠 포함)
- [x] Xcode Archive 및 App Store 업로드
- [x] 앱 암호화 설정 (해당 없음)
- [x] 심사 제출 완료 (2026.01.15)
...
- [x] PRD 문서
- [x] 프로젝트 개요
- [x] iOS 앱 배포 가이드 (app distribution.md)
